...
export default function Hero() {
  return (
    <section className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      <FadeIn delay={0}>
        <h1 className="flex flex-col items-center gap-2 text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
          <span>
      ...
      <FadeIn delay={0.15}>
        ...
        <FadeIn delay={0.3}>
          ...
          >
            {/* lapisan gelap saat hover - dinaikkan opacity-nya */}
            <span
